...
public class ArticleServiceFactory{
    ...
    public ArticleServiceFactory()
    {

    }

    public static ArticleService createArticleService(String fullyQualifiedName, Object ... base)
    {
        ArticleService record = null;
        try {
            Class<?> clz = Class.forName(fullyQualifiedName);
            Constructor<?> constructor = clz.getDeclaredConstructors()[0];
            record = (ArticleService) constructor.newInstance(base);
        } 
